        ...
        <div className={styles.grid}>
          ...
          <div>
            ...
            <ul className={styles.list}>
              <li><Link href="/productos?categoria=perros">Perros adultos</Link></li>
              <li><Link href="/productos?categoria=cachorros">Cachorros</Link></li>
              <li><Link href="/productos?categoria=gatos">Gatos adultos</Link></li>
              <li><Link href="/productos?categoria=gatitos">Gatitos</Link></li>
              <li><Link href="/productos?categoria=granos">Granos</Link></li>
